...
function em1(){var c="benjoAbmtfummd/dpn";var addr="mailto:";for(var i=0;i<c.length;i++)addr+=String.fromCharCode(c.charCodeAt(i)-1);window.location.href=addr;}
...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js1');e.setAttribute('src',(dpi>1)?'images/alset-logo_large-958.jpg':'images/alset-logo_large-479.jpg');};
